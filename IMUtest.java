...
public class IMUtest extends OpMode {
  ...
  public void init() {
    ...
    telemetry.addData("FtcRobotController", "IMU Init method finished in: "
            + (-(systemTime - (systemTime = System.currentTimeMillis()))) + " ms.");
  ...
  public void loop() {
    ...
    telemetry.addData("Pitch: ", String.format("Euler= %4.5f, Quat.= %4.5f", pitchAngle[0], pitchAngle[1]));
    telemetry.addData("Yaw: ", String.format("Euler= %4.5f, Quat.= %4.5f", yawAngle[0], yawAngle[1]));
  ...
  */
  ...
  public void stop() {
    ...
    Log.i("FtcRobotController", "IMU Stop method finished in: "
            + (-(systemTime - (systemTime = System.currentTimeMillis()))) + " ms.");
    telemetry.addData("FtcRobotController", "IMU Stop method finished in: "
            + (-(systemTime - (systemTime = System.currentTimeMillis()))) + " ms.");
  }
}